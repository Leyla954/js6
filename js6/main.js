...
// function city() {
//     let sanFransisco = []
//     for (let region of users) {
//         if (region.address.city == "San Francisco") {
//             sanFransisco.push(region)
...
// function department() {
//     let detalis = []
//     for (let engineer of users) {
//         if (engineer.company.department == "Engineering") {
//             detalis.push(engineer)
//             console.log(detalis);           
//         }
//     }
// }
...
//             arrMale.push(others);
//             console.log(arrMale);
//         } else if (others.gender == "female") {
//             arrFemale.push(others);
